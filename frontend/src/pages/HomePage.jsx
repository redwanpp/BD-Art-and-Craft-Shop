  ...
  return (
   <div className='relative min-h-screen text-white overflow-hidden'>
    <div className='relative z-10 max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8 py-16'>
      <h1 className='text-center text-4xl sm:text-5xl font-bold text-cyan-400 mb-4'>Explore Our Categories</h1>
      <p className='text-center text-xl text-gray-300 mb-12'>Discover the latest trends in eco-friendly products</p>
