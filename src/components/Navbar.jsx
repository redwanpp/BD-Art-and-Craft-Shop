      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            <Link
              to="/"
              className="text-gray-300 hover:text-cyan-400 transation duration-300 ease-in-out"
            >
              Home
            </Link>
            {user && (
              <Link to="/cart" className="relative group">
                ...
                {cart.length > 0 && (
                  <span className="absolute -top-2 -left-2 bg-cyan-500 text-white px-1.5 py-0.1 rounded-full group-hover:bg-cyan-400 transition duration-300 ease-in-out">
                    {cart.length}
                  </span>
                )}
              </Link>
